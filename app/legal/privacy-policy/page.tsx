...
export default function PrivacyPolicy() {
    return (
        <div className='w-full flex flex-col align-middle justify-center pt-8'>
            <div className='flex flex-col m-auto'>
                <h1>Privacy Policy</h1>

                <p>With this Privacy Policy, we, A-Block Technologies AG would like to inform you about how we process personal data
                    within the scope of our respective business activities and inform you about your rights. We are aware of the
                    importance of processing personal data for you as a data subject, and the protection of your privacy is of the
                    utmost importance to us.</p>

                <p>As an internationally operating law firm, respectively company, the EU General Data Protection Regulation (GDPR) is
                    important to us in addition to the Swiss data protection regulations. We have aligned this data protection
                    declaration to a uniform and stricter standard of the GDPR. This Privacy Notice must be read together with any
                    other legal notices or terms and conditions provided or made available to you.</p>

                <h2>I. Name and address of the controller</h2>

                <p>A-Block Technologies AG is an independent controller, which decides on the purpose and means of processing personal
                    data. If you have any questions regarding data protection, please do not hesitate to contact us:</p>

                <br/>

                <address>
                    A-Block Technologies AG<br />
                    Gartenstrasse 6<br />
                    6300 Zug<br />
                    Switzerland<br />
                ...
                <p>We primarily process personal data that we receive directly from our clients within the scope of our client
                    relationships. It is also possible that we receive or collect data from business partners or other persons
                    involved. Insofar as this is permitted and necessary, we also obtain data from publicly accessible sources (e.g.
                    public registers, media, Internet) or receive such data from our clients and their employees, from authorities,
                    (arbitration) courts and other third parties (e.g. counterparties, business partners and contractual partners of
                    our clients).</p>

                <p>In addition to the data that we receive directly from you, the categories of personal data that we receive from
                    third parties include, but are not limited to, the following:</p>

                <ul>
                    <li>Master data (e.g. names, addresses, functions, organizational affiliation, etc.)</li>
                    <li>Contact data (email address, phone number, etc.)</li>
                    <li>Content data (e.g. text and image files, videos, etc.)</li>
                    <li>Usage data (e.g. access data)</li>
                    <li>Meta/communication data (e.g. IP addresses)</li>
                    <li>Information from public registers (debt collection registers, commercial registers, land registers)</li>
                    <li>Information on compliance with legal requirements (e.g. combating money laundering and export restrictions)</li>
                    <li>Information related to your professional functions and activities</li>
                    <li>Information about you in correspondence and discussions with third parties</li>
                    <li>Creditworthiness information (if we conduct business with you personally)</li>
                    <li>Information from banks, insurance companies, distributors and other contractual partners from us on the use or provision of services by you (e.g. payments made/purchases made)</li>
                    <li>Information from media and Internet about you (as far as this is indicated in the concrete case), as well as</li>
                    <li>References for applications.</li>
                </ul>

                <h3>2. PURPOSES OF DATA PROCESSING AND LEGAL BASIS</h3>

                <p>We process the personal data collected in order to guarantee the performance of the relationship or for contract
                    processing, invoicing and communication purposes. Furthermore, we process personal data, as far as permitted and
                    necessary, also for the following purposes, in particular but not limited to those in which we (and also third
                    parties) have a legitimate interest corresponding to the purpose:</p>

                <ul>
                    <li>Measures for IT, building and plant security and protection of our employees and other persons and assets
                        entrusted to us (e.g. access controls, visitor lists, network and mail scanners, telephone records);</li>
                    <li>Any transactions under company law and the associated transfer of personal data as well as measures for
                        business management and compliance with legal and regulatory obligations.</li>
                    <li>Offer and further development of our offers and services</li>
                    <li>Advertising and marketing (including the organisation of events), provided that you have not objected to the
                        use of your data;</li>
                    <li>Market and opinion research, media monitoring.</li>
                </ul>

                <p>If you have given your consent to the processing of your personal data for certain purposes (e.g. to carry out a
                    background check), we will process your personal data within the scope of and based on this consent, insofar as we
                    have no other legal basis and we require such a basis. Any given consent can be revoked for the future at any
                    time.</p>

                <h4>3. DURATION OF STORAGE</h4>

                <p>The personal data collected by us will only be stored for as long as it is necessary for the execution of the relationship (from the initiation to the termination of a contract) or the other purposes pursued with the processing and/or a legal obligation to store and document or a predominant private or public interest exists. As soon as the personal data collected by us are no longer required for the above-mentioned purposes, it will be deleted or anonymised.</p>

                <br />

                <h2>III. Use of our website</h2>

                <br />

                <h3>A. PROVISION OF THE WEBSITE AND CREATION OF LOG FILES</h3>

                <br />

                <h4>1. DESCRIPTION AND SCOPE OF DATA PROCESSING</h4>

                <p>Each time you access our website, our system automatically collects data and information from the computer system of the accessing computer. The following data is collected:</p>
                ...
                <p>The IP addresses are stored in the log files of our system. This does not apply to the other data which enable the assignment of the data to a user. These data are not stored together with other personal data of the user.</p>
                ...
                <p>Our legitimate interest in data processing also lies in these purposes.</p>

                <br />

                <h4>3. DURATION OF STORAGE</h4>

                <p>The data will be deleted as soon as they are no longer necessary to achieve the purpose for which they were collected. In the case of the collection of data for the purpose of providing the website, this is the case when the respective session in question has ended.</p>

                <p>In the case of storage of data in log files, this is the case after seven days at the latest. Storage beyond this period is possible. In this case the IP addresses of the users are deleted or alienated so that an assignment of the calling client is no longer possible.</p>
                ...
                <p>Our website uses cookies. Cookies are small text files that are automatically stored on the hard disk of your computer when you visit our website. The cookies do not pose any danger to the computer.</p>
                ...
                <h4>2. PURPOSE OF DATA PROCESSING AND LEGAL BASIS</h4>

                <p>The purpose of using technically necessary cookies is to simplify the use of websites for users. Some functions of our website cannot be offered without the use of cookies. For these, it is necessary that the browser is recognized also after a page change.</p>

                <p>We need cookies for the following applications:</p>

                <ul>
                    <li>Adoption of language settings</li>
                    <li>Transfer of filter settings (team, magazine articles, publications)</li>
                </ul>

                <p>The user data collected by technically necessary cookies are not used to create user profiles.</p>

                <p>Cookies that are not technically necessary are used for the purpose of improving the quality of our website and its contents. These cookies tell us how the website is used and enable us to continually optimize our services.</p>

                <p>Our legitimate interest in the processing of personal data also lies in the aforementioned purposes.</p>

                <br />

                <h4>3. DURATION OF STORAGE, POSSIBILITY OF OBJECTION AND WITHDRAWAL</h4>
                ...
                <p>You can subscribe to newsletters on our website. We send our existing and potential clients information on blockchain, crypto and compliance issues at irregular intervals.</p>

                <p>Your consent to the processing of the data will be obtained before or during registration and reference will be made to this data protection declaration. The data will be used exclusively for the dispatch of the newsletter.</p>

                <br />

                <h4>2. PURPOSE OF DATA PROCESSING AND LEGAL BASIS</h4>

                <p>The collection of your e-mail address serves to deliver the newsletter. The collection of other personal data as part of the registration process serves to prevent misuse of the services or the e-mail address used.</p>

                <p>We process your personal data collected during registration for the newsletter based on your consent.</p>
                ...
                <h4>4. POSSIBILITY OF OPPOSITION AND WITHDRAWAL</h4>

                <p>The subscription of the newsletter can be cancelled by the affected user at any time. For this purpose, there is a corresponding link in every newsletter. This also enables the withdrawal of the consent to the storage of personal data collected during the registration process.</p>

                <br />

                <h3>D. CONTACT FORM AND E-MAIL CONTACT</h3>

                <br />

                <h4>1. DESCRIPTION AND SCOPE OF DATA PROCESSING</h4>

                <p>A contact form is available on our website, which can be used for electronic contact. If a user makes use of this possibility, the data entered in the input mask will be transmitted to us and stored. These data are:</p>

                <ul>
                    <li>First name and surname</li>
                    <li>Company (voluntary)</li>
                    <li>E-mail address (optional)</li>
                    <li>Background and information about your request (voluntary)</li>
                </ul>

                <p>The following data will also be stored at the time the message is sent:</p>

                <ul>
                    <li>IP address</li>
                    <li>Date and time of the sending process</li>
                    <li>Page on which the form was filled out</li>
                </ul>

                <p>Before sending the contact form we will refer to this privacy policy.</p>

                <p>Alternatively, it is possible to contact us via the e-mail address provided. In this case the personal data transmitted by you by e-mail will be stored.</p>

                <br />

                <h4>2. PURPOSES OF DATA PROCESSING AND LEGAL BASES</h4>
                ...
                <p>If the purpose of establishing contact is to conclude a contract, data processing is also necessary for the purpose of implementing pre-contractual measures as well as for the fulfilment and execution of the contract.</p>

                <br />

                <h4>3. DURATION OF STORAGE</h4>

                <p>In order to ensure compliance with our contractual and legal obligations (in particular with regard to storage and documentation obligations as an accredited lawyer), we require access to all user communications. Consequently, the personal data from the contact form or the personal data sent by e-mail will be deleted at the earliest after 10 years.</p>
                ...
                <h4>4. POSSIBILITY OF OBJECTION AND WITHDRAWAL</h4>

                <p>If data in the contact form is not clearly marked as voluntary and the processing is not carried out on the basis of a consent, we cannot provide our intended service if the consent for data processing is refused.</p>

                <br />

                <h3>E. DATA TRANSFER TO THIRD PARTIES AND TRANSBORDER DATA FLOWS</h3>

                <br />

                <h4>1. IT PROVIDER</h4>

                <p>We work with third parties who provide services to us and may share your personal information with them, for example with IT providers who may have limited access to your personal information in software or system support.</p>

                <br />

                <h4>2. USE OF MARKETING SERVICES</h4>

                <p>We may use Marketing Services from a variety of marketing service providers, on our website for our online marketing activities.</p>
                ...
                <p>If a collection by a Marketing Service Provider is generally not desired, the storage of cookies can be prevented at any time by appropriate browser settings (see above under point B.3).</p>

                <br />

                <h4>3. WEB ANALYSIS BY GOOGLE ANALYTICS</h4>
                ...
                <h5>3.2 PURPOSES OF DATA PROCESSING AND LEGAL BASIS</h5>
                ...
                <h5>3.3 DURATION OF THE STORAGE AS WELL AS OBJECTION AND WITHDRAWAL POSSIBILITY</h5>
                ...
                <p>Information from the third party provider Google:</p>

                <p>Address: Google Dublin, Google Ireland Ltd., Gordon House, Barrow Street, Dublin 4, Ireland. Terms of use: <a href="http://www.google.com/analytics/terms/de.html">http://www.google.com/analytics/terms/de.html</a>.</p>

                <p>Overview of data protection: <a href="http://www.google.com/intl/de/analytics/learn/privacy.html">http://www.google.com/intl/de/analytics/learn/privacy.html</a>, and the privacy policy: <a href="http://www.google.de/intl/de/policies/privacy">http://www.google.de/intl/de/policies/privacy</a>.</p>

                <br />

                <h4>4. DATA PROTECTION FOR PROTECTION FOR APPLICATIONS</h4>

                <p>The data controller shall collect and process the personal data of applicants for the purpose of the processing of the applications. The processing may also be carried out electronically. This is the case, in particular, if an applicant submits corresponding application documents by e-mail or by means of a web form on the website to the controller.</p>

                <br />

                <h4>5. DATA PROTECTION PROVISIONS ABOUT THE APPLICATION AND USE BY FACEBOOK</h4>
                ...
                <h4>7. DATA PROTECTION PROVISIONS ABOUT THE APPLICATION AND USE OF X (Twitter)</h4>
                ...
                <p>YouTube’s data protection provisions, available at <a href="https://www.google.com/intl/en/policies/privacy/">https://www.google.com/intl/en/policies/privacy/</a>, provide information about the collection, processing and use of personal data by YouTube and Google.</p>

                <br />

                <h2>IV. Rights of the data subject</h2>
                ...
                <p>If we process data on the basis of your consent, you have the right to withdraw your consent with effect for the future at any time.</p>

                <p>In addition, you have the right to object to the processing of your data if we process it based on our legitimate interests or for direct marketing purposes.</p>

                <p>Please note that even if you have decided to withdraw your consent, we may continue to process your personal data to the extent required or permitted by law.</p>

                <br />

                <h2>V. Amendments to this privacy statement</h2>

                <p>We reserve the right to change this Privacy Policy at any time without notice. We will notify you of any changes by posting the updated Privacy Policy on our website. Any changes we make will be effective from the date we post them on our website.</p>

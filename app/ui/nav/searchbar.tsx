...
export default function Searchbar() {
    return (
        <Input
            disabled
            label="Search"
            icon={<MagnifyingGlassCircleIcon onClick={() => null} className="hidden lg:block text-gray-500 hover:text-gray-900 hover:cursor-pointer active:w-4 active:h-4 active:rounded-lg active:text-gray-500" />}
            placeholder="Search"
